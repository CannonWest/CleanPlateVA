 ...
 *  `public/data/facilities.json`, the multi-megabyte public payload that ships to
 ...
 *
 *  The failure that earns this file: lite's `mobile` boolean (one of 12 fields,
 ...
 *  so a roster without `mobile` renders it VISIBLE AND INERT — all mobile units

...
test('the full channel is gated behind !FORCE_LITE and degrades only to V3 lite', () => {
    ...
    const full = body.indexOf('loadFullV3');
    ...
    assert.ok(lite > full, 'the public V3 fallback stays after the full gate');
});
